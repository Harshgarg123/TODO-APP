...
const AddEditNotes = ({noteData,type,getAllNotes,onClose,showToastMessage}) => {
    ...
    const handleAddNote = () =>{
        ...
        if (!content) {
            setError("Please select a content");
            return;
        }
        setError("");
        if(type === 'edit'){
  ...
  return (
    <div className="relative">
        <button className="w-10 h-10 rounded-full items-center justify-center absolute -top-3 -right-3 hover:bg-slate-500" onClick={onClose}>
